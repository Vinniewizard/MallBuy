  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-slate-950 relative overflow-hidden"><div className="absolute inset-0 overflow-hidden pointer-events-none z-0"><div className="absolute -top-1/4 -left-1/4 w-full h-full bg-blue-600/20 rounded-full blur-[120px]"></div><div className="absolute top-1/2 -right-1/4 w-full h-full bg-emerald-500/10 rounded-full blur-[120px]"></div></div><div className="relative z-10 w-full h-full flex flex-col">
      ...
      <div className="w-full h-20 px-8 flex items-center justify-between bg-white/5 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="text-sm font-semibold text-white bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-lg transition-colors cursor-pointer"
          >
            Create account
          </button>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-[480px] bg-white/5 rounded-2xl shadow-xl overflow-hidden p-8 sm:p-10 relative">
          ...
          <div className="mb-8 text-left">
            {(() => {
              ...
              return (
                <>
                  <span className={`text-[10px] font-black tracking-wider uppercase mb-2 block ${isAdminPath ? "text-rose-400 bg-rose-500/10 px-2 py-0.5 rounded border border-rose-500/20 inline-block" : "text-amber-400"}`}>
                  ...
                  {isAdminPath && (
                    <p className="text-[11px] text-slate-400 font-semibold leading-relaxed mt-2.5">
                      Authentication required. Please authenticate below using your authorized <strong className="text-rose-400 font-black">GADMIN</strong> credentials.
                    </p>
                  )}
                </>
              );
          ...
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-lg flex items-start gap-2 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all font-medium text-sm border border-transparent"
      ...
      {whatsappEnabled && (
        <div className="fixed bottom-6 right-6">
          <a href={whatsappUrl} target="_blank" rel="noreferrer" className="block bg-[#25D366] p-4 rounded-full shadow-lg shadow-green-500/30 hover:scale-110 transition-transform">
