  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans relative">
           ...
           <div>
            ...
            {whatsappEnabled && (
              <div>
                 ...
                 <a href={whatsappUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-2.5 rounded-lg text-sm transition-colors cursor-pointer">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col sm:flex-row items-center gap-3">
        ...
        {/* WhatsApp float */}
        {whatsappEnabled && (
          <a href={whatsappUrl} target="_blank" rel="noreferrer" className="block bg-emerald-500 p-4 rounded-full shadow-lg shadow-emerald-500/20 hover:scale-110 transition-transform cursor-pointer" title="Join WhatsApp Group">
