  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans relative">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col sm:flex-row items-center gap-3">
        ...
        {/* WhatsApp float */}
        <a href="https://chat.whatsapp.com/GebCk8EB9i259AOMQaIpmH" target="_blank" rel="noreferrer" className="block bg-emerald-500 p-4 rounded-full shadow-lg shadow-emerald-500/20 hover:scale-110 transition-transform cursor-pointer" title="Join WhatsApp Group">
